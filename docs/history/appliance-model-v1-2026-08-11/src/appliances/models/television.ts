...
export function createTelevisionModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const rearShell = kit.mesh(
    ...
    new RoundedBoxGeometry(3.22, 2.18, 1.5, 5, 0.18),
    shellMaterial,
  );
  ...
  const rearCap = kit.mesh(
    'television-rear-cap',
    new RoundedBoxGeometry(2.88, 1.85, 0.28, 4, 0.15),
    shellShadowMaterial,
  );
  ...
  const frontFascia = kit.mesh(
    ...
    new RoundedBoxGeometry(3.45, 2.14, 0.31, 5, 0.17),
  ...
  const screenFrame = kit.mesh(
    ...
    new RoundedBoxGeometry(2.55, 1.77, 0.13, 5, 0.22),
    shellShadowMaterial,
  );
  ...
  const controlPanel = kit.mesh(
    ...
    new RoundedBoxGeometry(0.63, 1.73, 0.105, 4, 0.11),
    accentMaterial,
  );
  ...
  const rearPanel = kit.mesh(
    ...
    new RoundedBoxGeometry(2.75, 1.62, 0.055, 4, 0.13),
    shellHighlightMaterial,
  );
