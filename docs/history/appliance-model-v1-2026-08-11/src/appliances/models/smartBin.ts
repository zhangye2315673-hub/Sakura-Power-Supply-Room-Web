...
export function createSmartBinModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const build = kit.finish(
    {
      ...
      reconstructed: [
        'rounded cream rectangular body with separate Sakura rose upper rail and lower skirt',
        'raised rose lid with rear-axis pivot, inset inner panel and paired hinge blocks',
        'genuinely open mouth with four vertical liner walls and a floor recessed 0.82 units below the rim',
        'back-view rectangular handle recess, four independent feet and seam rails',
  ...
  build.root.userData.sculptRuntime.destructionGroups = [
    { id: 'body-shell', nodes: ['smart-bin-body-shell', 'smart-bin-upper-rose-rail', 'smart-bin-bottom-rose-skirt', 'smart-bin-inner-cavity'] },
    { id: 'lid-assembly', nodes: ['smart-bin-lid-hinge-pivot', 'smart-bin-rose-lid-shell', 'smart-bin-lid-inner-panel'] },
    { id: 'sensor-module', nodes: ['smart-bin-infrared-sensor-window', 'smart-bin-sensor-glow-strip'] },
