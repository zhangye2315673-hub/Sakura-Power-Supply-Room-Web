...
import { T as cableJelly, b as poweredActiveDuration, i as RoundedBoxGeometry, t as mergeGeometries, x as poweredAnimationState } from "./BufferGeometryUtils-Bf_-bT2g.js";
import { c as markSharedResource, l as SOFT_CAGE_FUNCTION_GLSL, s as disposeOwnedResource, t as addHullOutline, u as SOFT_CAGE_UNIFORM_GLSL } from "./outline-Brkgge31.js";
import { n as createAlarmClockModel } from "./alarmClock-DapLoRtU.js";
import { n as createBlenderModel } from "./blender-D3SUTsso.js";
import { n as createBubbleMachineModel } from "./bubbleMachine-C8qJWgMF.js";
import { n as createCoffeeMakerModel } from "./coffeeMaker-BayCLVWo.js";
import { t as createDehumidifierModel } from "./dehumidifier-CTcn8U8a.js";
import { t as createDesktopComputerModel } from "./desktopComputer-9F9NWp_c.js";
import { t as createFanModel } from "./fan-CWMxlgrl.js";
import { t as createGameControllerModel } from "./gameController-Banx8Yuu.js";
import { t as createGumballMachineModel } from "./gumballMachine-BjLcMUlR.js";
import { t as createHairDryerModel } from "./hairDryer-Rbu24a5c.js";
import { t as createHumidifierModel } from "./humidifier-CiX5SZb9.js";
import { t as createInductionCooktopModel } from "./inductionCooktop-6pZRMZiZ.js";
import { t as createKettleModel } from "./kettle-DQ0-awcn.js";
import { t as createLampModel } from "./lamp-u_hXl3EH.js";
import { t as createMicrowaveModel } from "./microwave-CsGOMMka.js";
import { t as createPhoneModel } from "./phone-8TF9hijf.js";
import { t as createPopcornMachineModel } from "./popcornMachine-BLx5vYyi.js";
import { t as createPortableSpeakerModel } from "./portableSpeaker-CACSoz-x.js";
import { t as createPrinterModel } from "./printer-YiClCeLS.js";
import { t as createRadioModel } from "./radio-Bbam5g2u.js";
import { t as createRecordPlayerModel } from "./recordPlayer-CrSQrUV-.js";
import { t as createRefrigeratorModel } from "./refrigerator-CdvVnztT.js";
import { t as createRiceCookerModel } from "./riceCooker-D5hHPZl-.js";
import { t as createRobotVacuumModel } from "./robotVacuum-BFFHDfj_.js";
import { t as createSmartBinModel } from "./smartBin-DhQKDqV5.js";
import { t as createStandMixerModel } from "./standMixer-Dsx5uCx_.js";
import { t as createTelevisionModel } from "./television-CMOKW76F.js";
import { t as createToasterModel } from "./toaster-DiU7ds3y.js";
import { t as createWasherModel } from "./washer-DBzI1vUj.js";
...
var ApplianceScene = class {
	...
	fitTargetToViewport(target) {
		...
		if (this.canvas && this.canvas.clientWidth <= 760 && aspect < .8) {
			...
			scale = Math.min(.21 / size.x, .2 * aspect / size.y);
		}
...
//#endregion
export { setCableSkillSweep as A, PLUG_HEAD_MAX_RADIUS as B, createRoundedCableGeometry as C, setCableIceShell as D, setCableFreeze as E, EXIT_DISTANCE as F, cableSocketPointsToWorld as G, PLUG_HEAD_PIN_RADIUS as H, LANE_PITCH as I, directionKeyFromDelta as K, PLUG_HEAD_BODY_CLEARANCE_LENGTH as L, CABLE_TAIL_TERMINAL_LENGTH as M, COLLISION_RADIUS as N, setCableOverheat as O, DIRECTION_VECTORS as P, PLUG_HEAD_CLEARANCE as R, createCableToonMaterial as S, setCableCoffeeStain as T, STATIC_BODY_CLEARANCE as U, PLUG_HEAD_PIN_CLEARANCE as V, STATIC_PLUG_CLEARANCE as W, REFRIGERATOR_FREEZE_COLOR as _, jellyDefaults as a, REFRIGERATOR_SPIKE_OPACITY as b, setJellyDynamics as c, PLUG_HEAD_ENVELOPE as d, PLUG_STYLE_IDS as f, COFFEE_STAIN_COLOR as g, CABLE_RADIUS as h, getJellyFeel as i, ARROW_RADIUS as j, setCableSkillRecolor as k, setJellyFeel as l, createPlugHead as m, ApplianceTarget as n, jellyDynamics as o, PLUG_STYLE_LABELS as p, CooperativeYieldBudget as q, SoftDeformController as r, saveJellyDynamics as s, ApplianceScene as t, createApplianceModel as u, REFRIGERATOR_ICE_COLOR as v, createRoundedIceShellGeometry as w, createCableIceShellMaterial as x, REFRIGERATOR_ICE_OPACITY as y, PLUG_HEAD_MAX_LENGTH as z };
