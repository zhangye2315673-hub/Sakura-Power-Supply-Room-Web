...
function selectCampaignAppliances(ids, count) {
	return ids.slice(0, Math.max(1, Math.min(ids.length, count))).map(definition);
}
//#endregion
export { selectCampaignAppliances as i, applianceCatalogSummary as n, selectAppliancesForSeed as r, APPLIANCE_CATALOG as t };
