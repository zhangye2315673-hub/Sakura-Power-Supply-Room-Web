...
import { E as installJellyEnvironment, S as poweredPreviewCycleDuration, x as poweredAnimationState } from "./BufferGeometryUtils-B_UDylAy.js";
import { C as OrbitControls, f as AppliancePerformanceSystem, t as PetalField } from "./PetalField-Db8ZGoQQ.js";
//#region src/review/modelReview.ts
var modules = /* #__PURE__ */ Object.assign({
	"../appliances/models/alarmClock.ts": () => __vitePreload(() => import("./alarmClock-BNlAQNeN.js").then((n) => n.t), __vite__mapDeps([0,1,2,3,4,5]), import.meta.url),
	"../appliances/models/blender.ts": () => __vitePreload(() => import("./blender-BDBHYjdo.js").then((n) => n.t), __vite__mapDeps([6,1,2,3,4,5]), import.meta.url),
	"../appliances/models/bubbleMachine.ts": () => __vitePreload(() => import("./bubbleMachine-D2b3QY1Z.js").then((n) => n.t), __vite__mapDeps([7,1,2,3,4,5]), import.meta.url),
	"../appliances/models/coffeeMaker.ts": () => __vitePreload(() => import("./coffeeMaker-B2t1DEA1.js").then((n) => n.t), __vite__mapDeps([8,1,2,3,4,5]), import.meta.url),
	"../appliances/models/dehumidifier.ts": () => __vitePreload(() => import("./dehumidifier-8cAY-H4Y.js").then((n) => n.n), __vite__mapDeps([9,1,2,3,4,5]), import.meta.url),
	"../appliances/models/desktopComputer.ts": () => __vitePreload(() => import("./desktopComputer-CG4Fq4Jb.js").then((n) => n.n), __vite__mapDeps([10,1,2,3,4,5]), import.meta.url),
	"../appliances/models/fan.ts": () => __vitePreload(() => import("./fan-BMhmD4-i.js").then((n) => n.n), __vite__mapDeps([11,1,2,5,4,3]), import.meta.url),
	"../appliances/models/gameController.ts": () => __vitePreload(() => import("./gameController-D1xOIvTz.js").then((n) => n.n), __vite__mapDeps([12,1,2,3,4,5]), import.meta.url),
	"../appliances/models/gumballMachine.ts": () => __vitePreload(() => import("./gumballMachine-BY4TpQxR.js").then((n) => n.n), __vite__mapDeps([13,1,2,3,4,5]), import.meta.url),
	"../appliances/models/hairDryer.ts": () => __vitePreload(() => import("./hairDryer-BrQ5r1Ff.js").then((n) => n.n), __vite__mapDeps([14,1,2,3,4,5]), import.meta.url),
	"../appliances/models/humidifier.ts": () => __vitePreload(() => import("./humidifier-t_mXQZ6z.js").then((n) => n.n), __vite__mapDeps([15,1,2,3,4,5]), import.meta.url),
	"../appliances/models/inductionCooktop.ts": () => __vitePreload(() => import("./inductionCooktop-D_3vZVVR.js").then((n) => n.n), __vite__mapDeps([16,1,2,3,4,5]), import.meta.url),
	"../appliances/models/kettle.ts": () => __vitePreload(() => import("./kettle--aaeMZVw.js").then((n) => n.n), __vite__mapDeps([17,1,2,3,4,5]), import.meta.url),
	"../appliances/models/lamp.ts": () => __vitePreload(() => import("./lamp-DScv1mJm.js").then((n) => n.n), __vite__mapDeps([18,1,2,3,4,5]), import.meta.url),
	"../appliances/models/microwave.ts": () => __vitePreload(() => import("./microwave-CxH7q6I_.js").then((n) => n.n), __vite__mapDeps([19,1,2,3,4,5]), import.meta.url),
	"../appliances/models/phone.ts": () => __vitePreload(() => import("./phone-XQIskcS6.js").then((n) => n.n), __vite__mapDeps([20,1,2,3,4,5]), import.meta.url),
	"../appliances/models/popcornMachine.ts": () => __vitePreload(() => import("./popcornMachine-BHftRIvL.js").then((n) => n.n), __vite__mapDeps([21,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/portableSpeaker.ts": () => __vitePreload(() => import("./portableSpeaker-B5SWK5eq.js").then((n) => n.n), __vite__mapDeps([23,1,2,3,4,5]), import.meta.url),
	"../appliances/models/printer.ts": () => __vitePreload(() => import("./printer-Zr8hcY-8.js").then((n) => n.n), __vite__mapDeps([24,1,2,3,4,5]), import.meta.url),
	"../appliances/models/radio.ts": () => __vitePreload(() => import("./radio-L7jYXCvV.js").then((n) => n.n), __vite__mapDeps([25,1,2,3,4,5]), import.meta.url),
	"../appliances/models/recordPlayer.ts": () => __vitePreload(() => import("./recordPlayer-XJTtlw6v.js").then((n) => n.n), __vite__mapDeps([26,1,2,3,4,5]), import.meta.url),
	"../appliances/models/refrigerator.ts": () => __vitePreload(() => import("./refrigerator-bFxs-Qd0.js").then((n) => n.n), __vite__mapDeps([27,1,2,3,4,5]), import.meta.url),
	"../appliances/models/riceCooker.ts": () => __vitePreload(() => import("./riceCooker-CGLqYEX-.js").then((n) => n.n), __vite__mapDeps([28,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/robotVacuum.ts": () => __vitePreload(() => import("./robotVacuum-D0csz3kr.js").then((n) => n.n), __vite__mapDeps([29,1,2,3,4,5]), import.meta.url),
	"../appliances/models/smartBin.ts": () => __vitePreload(() => import("./smartBin-DJVpKjGh.js").then((n) => n.n), __vite__mapDeps([30,1,2,3,4,5]), import.meta.url),
	"../appliances/models/standMixer.ts": () => __vitePreload(() => import("./standMixer-BZzMtHNs.js").then((n) => n.n), __vite__mapDeps([31,1,2,3,4,5]), import.meta.url),
	"../appliances/models/television.ts": () => __vitePreload(() => import("./television-CF1VEOG3.js").then((n) => n.n), __vite__mapDeps([32,1,2,3,4,5]), import.meta.url),
	"../appliances/models/toaster.ts": () => __vitePreload(() => import("./toaster-DCkoL_wG.js").then((n) => n.n), __vite__mapDeps([33,1,2,3,4,5]), import.meta.url),
	"../appliances/models/washer.ts": () => __vitePreload(() => import("./washer-CyT15SzA.js").then((n) => n.n), __vite__mapDeps([34,1,2,3,4,5]), import.meta.url)
});
