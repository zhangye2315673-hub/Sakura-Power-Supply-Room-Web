...
import { t as ThemeController } from "./game-C9MCl_WK.js";
...
var Game = class {
	...
	constructor(canvas) {
		...
		this.puzzleWorker = new Worker(new URL(
			/* @vite-ignore */
			"" + new URL("generator.worker-CSRwk2xo.js", import.meta.url).href,
			"" + import.meta.url
		), { type: "module" });
