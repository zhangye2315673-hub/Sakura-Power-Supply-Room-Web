const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./alarmClock-DapLoRtU.js","./rolldown-runtime-D7D4PA-g.js","./three.core-DlTOC7bx.js","./BufferGeometryUtils-Bf_-bT2g.js","./palette-CaCEpJJd.js","./outline-Brkgge31.js","./blender-D3SUTsso.js","./bubbleMachine-C8qJWgMF.js","./coffeeMaker-BayCLVWo.js","./dehumidifier-CTcn8U8a.js","./desktopComputer-9F9NWp_c.js","./fan-CWMxlgrl.js","./gameController-Banx8Yuu.js","./gumballMachine-BjLcMUlR.js","./hairDryer-Rbu24a5c.js","./humidifier-CiX5SZb9.js","./inductionCooktop-6pZRMZiZ.js","./kettle-DQ0-awcn.js","./lamp-u_hXl3EH.js","./microwave-CsGOMMka.js","./phone-8TF9hijf.js","./popcornMachine-BLx5vYyi.js","./ParametricGeometry-B8cqH16S.js","./portableSpeaker-CACSoz-x.js","./printer-YiClCeLS.js","./radio-Bbam5g2u.js","./recordPlayer-CrSQrUV-.js","./refrigerator-CdvVnztT.js","./riceCooker-D5hHPZl-.js","./robotVacuum-BFFHDfj_.js","./smartBin-DhQKDqV5.js","./standMixer-Dsx5uCx_.js","./television-CMOKW76F.js","./toaster-DiU7ds3y.js","./washer-DBzI1vUj.js"])))=>i.map(i=>d[i]);
...
import { s as WebGLRenderer } from "./palette-CaCEpJJd.js";
import { t as __vitePreload } from "./preload-helper-DHlaQ_oz.js";
import { t as APPLIANCE_CATALOG } from "./ApplianceCatalog-2_-hlaHk.js";
import { E as installJellyEnvironment, S as poweredPreviewCycleDuration, x as poweredAnimationState } from "./BufferGeometryUtils-Bf_-bT2g.js";
import { C as OrbitControls, f as AppliancePerformanceSystem, t as PetalField } from "./PetalField-DFT0OWiW.js";
//#region src/review/modelReview.ts
var modules = /* #__PURE__ */ Object.assign({
	"../appliances/models/alarmClock.ts": () => __vitePreload(() => import("./alarmClock-DapLoRtU.js").then((n) => n.t), __vite__mapDeps([0,1,2,3,4,5]), import.meta.url),
	"../appliances/models/blender.ts": () => __vitePreload(() => import("./blender-D3SUTsso.js").then((n) => n.t), __vite__mapDeps([6,1,2,3,4,5]), import.meta.url),
	"../appliances/models/bubbleMachine.ts": () => __vitePreload(() => import("./bubbleMachine-C8qJWgMF.js").then((n) => n.t), __vite__mapDeps([7,1,2,3,4,5]), import.meta.url),
	"../appliances/models/coffeeMaker.ts": () => __vitePreload(() => import("./coffeeMaker-BayCLVWo.js").then((n) => n.t), __vite__mapDeps([8,1,2,3,4,5]), import.meta.url),
	"../appliances/models/dehumidifier.ts": () => __vitePreload(() => import("./dehumidifier-CTcn8U8a.js").then((n) => n.n), __vite__mapDeps([9,1,2,3,4,5]), import.meta.url),
	"../appliances/models/desktopComputer.ts": () => __vitePreload(() => import("./desktopComputer-9F9NWp_c.js").then((n) => n.n), __vite__mapDeps([10,1,2,3,4,5]), import.meta.url),
	"../appliances/models/fan.ts": () => __vitePreload(() => import("./fan-CWMxlgrl.js").then((n) => n.n), __vite__mapDeps([11,1,2,5,4,3]), import.meta.url),
	"../appliances/models/gameController.ts": () => __vitePreload(() => import("./gameController-Banx8Yuu.js").then((n) => n.n), __vite__mapDeps([12,1,2,3,4,5]), import.meta.url),
	"../appliances/models/gumballMachine.ts": () => __vitePreload(() => import("./gumballMachine-BjLcMUlR.js").then((n) => n.n), __vite__mapDeps([13,1,2,3,4,5]), import.meta.url),
	"../appliances/models/hairDryer.ts": () => __vitePreload(() => import("./hairDryer-Rbu24a5c.js").then((n) => n.n), __vite__mapDeps([14,1,2,3,4,5]), import.meta.url),
	"../appliances/models/humidifier.ts": () => __vitePreload(() => import("./humidifier-CiX5SZb9.js").then((n) => n.n), __vite__mapDeps([15,1,2,3,4,5]), import.meta.url),
	"../appliances/models/inductionCooktop.ts": () => __vitePreload(() => import("./inductionCooktop-6pZRMZiZ.js").then((n) => n.n), __vite__mapDeps([16,1,2,3,4,5]), import.meta.url),
	"../appliances/models/kettle.ts": () => __vitePreload(() => import("./kettle-DQ0-awcn.js").then((n) => n.n), __vite__mapDeps([17,1,2,3,4,5]), import.meta.url),
	"../appliances/models/lamp.ts": () => __vitePreload(() => import("./lamp-u_hXl3EH.js").then((n) => n.n), __vite__mapDeps([18,1,2,3,4,5]), import.meta.url),
	"../appliances/models/microwave.ts": () => __vitePreload(() => import("./microwave-CsGOMMka.js").then((n) => n.n), __vite__mapDeps([19,1,2,3,4,5]), import.meta.url),
	"../appliances/models/phone.ts": () => __vitePreload(() => import("./phone-8TF9hijf.js").then((n) => n.n), __vite__mapDeps([20,1,2,3,4,5]), import.meta.url),
	"../appliances/models/popcornMachine.ts": () => __vitePreload(() => import("./popcornMachine-BLx5vYyi.js").then((n) => n.n), __vite__mapDeps([21,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/portableSpeaker.ts": () => __vitePreload(() => import("./portableSpeaker-CACSoz-x.js").then((n) => n.n), __vite__mapDeps([23,1,2,3,4,5]), import.meta.url),
	"../appliances/models/printer.ts": () => __vitePreload(() => import("./printer-YiClCeLS.js").then((n) => n.n), __vite__mapDeps([24,1,2,3,4,5]), import.meta.url),
	"../appliances/models/radio.ts": () => __vitePreload(() => import("./radio-Bbam5g2u.js").then((n) => n.n), __vite__mapDeps([25,1,2,3,4,5]), import.meta.url),
	"../appliances/models/recordPlayer.ts": () => __vitePreload(() => import("./recordPlayer-CrSQrUV-.js").then((n) => n.n), __vite__mapDeps([26,1,2,3,4,5]), import.meta.url),
	"../appliances/models/refrigerator.ts": () => __vitePreload(() => import("./refrigerator-CdvVnztT.js").then((n) => n.n), __vite__mapDeps([27,1,2,3,4,5]), import.meta.url),
	"../appliances/models/riceCooker.ts": () => __vitePreload(() => import("./riceCooker-D5hHPZl-.js").then((n) => n.n), __vite__mapDeps([28,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/robotVacuum.ts": () => __vitePreload(() => import("./robotVacuum-BFFHDfj_.js").then((n) => n.n), __vite__mapDeps([29,1,2,3,4,5]), import.meta.url),
	"../appliances/models/smartBin.ts": () => __vitePreload(() => import("./smartBin-DhQKDqV5.js").then((n) => n.n), __vite__mapDeps([30,1,2,3,4,5]), import.meta.url),
	"../appliances/models/standMixer.ts": () => __vitePreload(() => import("./standMixer-Dsx5uCx_.js").then((n) => n.n), __vite__mapDeps([31,1,2,3,4,5]), import.meta.url),
	"../appliances/models/television.ts": () => __vitePreload(() => import("./television-CMOKW76F.js").then((n) => n.n), __vite__mapDeps([32,1,2,3,4,5]), import.meta.url),
	"../appliances/models/toaster.ts": () => __vitePreload(() => import("./toaster-DiU7ds3y.js").then((n) => n.n), __vite__mapDeps([33,1,2,3,4,5]), import.meta.url),
	"../appliances/models/washer.ts": () => __vitePreload(() => import("./washer-DBzI1vUj.js").then((n) => n.n), __vite__mapDeps([34,1,2,3,4,5]), import.meta.url)
});
