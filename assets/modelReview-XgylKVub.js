const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./alarmClock-Bfcqi7Rn.js","./rolldown-runtime-D7D4PA-g.js","./three.core-DlTOC7bx.js","./BufferGeometryUtils-CSuwXBGj.js","./palette-knpLSfXB.js","./outline-DAm9XhPL.js","./blender-D9hYElrC.js","./bubbleMachine-DAWHqOuQ.js","./coffeeMaker-DPn496v_.js","./dehumidifier-Bp9U4Q2k.js","./desktopComputer-DAkQCft8.js","./fan-CbLuYVJa.js","./gameController-Chmzg1k_.js","./gumballMachine-CdNk3Unu.js","./hairDryer-DoNkKMiP.js","./humidifier-BI1Os-bg.js","./inductionCooktop-DNd8UKgB.js","./kettle-DuZE9F1_.js","./lamp-Cz398Pho.js","./microwave-vXGGlHmA.js","./phone-ClPIxyuT.js","./popcornMachine-CcMzNfI2.js","./ParametricGeometry-CNqXT5Mu.js","./portableSpeaker-DgyrMaWd.js","./printer-BQq0jkQh.js","./radio-Ekjy9JCU.js","./recordPlayer-LHSCFBeS.js","./refrigerator-B-xhOxfl.js","./riceCooker-CgcMjeIo.js","./robotVacuum-DnqYpj6X.js","./smartBin-B-UlZqBe.js","./standMixer-Ml3tfuLd.js","./television-DN_8Dz3m.js","./toaster-CkQRGCbY.js","./washer-BQrlLbRy.js"])))=>i.map(i=>d[i]);
...
import { T as installJellyEnvironment, b as poweredAnimationState, x as poweredPreviewCycleDuration } from "./BufferGeometryUtils-CSuwXBGj.js";
import { C as OrbitControls, f as AppliancePerformanceSystem, t as PetalField } from "./PetalField-BM6CfiyA.js";
//#region src/review/modelReview.ts
var modules = /* #__PURE__ */ Object.assign({
	"../appliances/models/alarmClock.ts": () => __vitePreload(() => import("./alarmClock-Bfcqi7Rn.js").then((n) => n.t), __vite__mapDeps([0,1,2,3,4,5]), import.meta.url),
	"../appliances/models/blender.ts": () => __vitePreload(() => import("./blender-D9hYElrC.js").then((n) => n.t), __vite__mapDeps([6,1,2,3,4,5]), import.meta.url),
	"../appliances/models/bubbleMachine.ts": () => __vitePreload(() => import("./bubbleMachine-DAWHqOuQ.js").then((n) => n.t), __vite__mapDeps([7,1,2,3,4,5]), import.meta.url),
	"../appliances/models/coffeeMaker.ts": () => __vitePreload(() => import("./coffeeMaker-DPn496v_.js").then((n) => n.t), __vite__mapDeps([8,1,2,3,4,5]), import.meta.url),
	"../appliances/models/dehumidifier.ts": () => __vitePreload(() => import("./dehumidifier-Bp9U4Q2k.js").then((n) => n.n), __vite__mapDeps([9,1,2,3,4,5]), import.meta.url),
	"../appliances/models/desktopComputer.ts": () => __vitePreload(() => import("./desktopComputer-DAkQCft8.js").then((n) => n.n), __vite__mapDeps([10,1,2,3,4,5]), import.meta.url),
	"../appliances/models/fan.ts": () => __vitePreload(() => import("./fan-CbLuYVJa.js").then((n) => n.n), __vite__mapDeps([11,1,2,5,4,3]), import.meta.url),
	"../appliances/models/gameController.ts": () => __vitePreload(() => import("./gameController-Chmzg1k_.js").then((n) => n.n), __vite__mapDeps([12,1,2,3,4,5]), import.meta.url),
	"../appliances/models/gumballMachine.ts": () => __vitePreload(() => import("./gumballMachine-CdNk3Unu.js").then((n) => n.n), __vite__mapDeps([13,1,2,3,4,5]), import.meta.url),
	"../appliances/models/hairDryer.ts": () => __vitePreload(() => import("./hairDryer-DoNkKMiP.js").then((n) => n.n), __vite__mapDeps([14,1,2,3,4,5]), import.meta.url),
	"../appliances/models/humidifier.ts": () => __vitePreload(() => import("./humidifier-BI1Os-bg.js").then((n) => n.n), __vite__mapDeps([15,1,2,3,4,5]), import.meta.url),
	"../appliances/models/inductionCooktop.ts": () => __vitePreload(() => import("./inductionCooktop-DNd8UKgB.js").then((n) => n.n), __vite__mapDeps([16,1,2,3,4,5]), import.meta.url),
	"../appliances/models/kettle.ts": () => __vitePreload(() => import("./kettle-DuZE9F1_.js").then((n) => n.n), __vite__mapDeps([17,1,2,3,4,5]), import.meta.url),
	"../appliances/models/lamp.ts": () => __vitePreload(() => import("./lamp-Cz398Pho.js").then((n) => n.n), __vite__mapDeps([18,1,2,3,4,5]), import.meta.url),
	"../appliances/models/microwave.ts": () => __vitePreload(() => import("./microwave-vXGGlHmA.js").then((n) => n.n), __vite__mapDeps([19,1,2,3,4,5]), import.meta.url),
	"../appliances/models/phone.ts": () => __vitePreload(() => import("./phone-ClPIxyuT.js").then((n) => n.n), __vite__mapDeps([20,1,2,3,4,5]), import.meta.url),
	"../appliances/models/popcornMachine.ts": () => __vitePreload(() => import("./popcornMachine-CcMzNfI2.js").then((n) => n.n), __vite__mapDeps([21,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/portableSpeaker.ts": () => __vitePreload(() => import("./portableSpeaker-DgyrMaWd.js").then((n) => n.n), __vite__mapDeps([23,1,2,3,4,5]), import.meta.url),
	"../appliances/models/printer.ts": () => __vitePreload(() => import("./printer-BQq0jkQh.js").then((n) => n.n), __vite__mapDeps([24,1,2,3,4,5]), import.meta.url),
	"../appliances/models/radio.ts": () => __vitePreload(() => import("./radio-Ekjy9JCU.js").then((n) => n.n), __vite__mapDeps([25,1,2,3,4,5]), import.meta.url),
	"../appliances/models/recordPlayer.ts": () => __vitePreload(() => import("./recordPlayer-LHSCFBeS.js").then((n) => n.n), __vite__mapDeps([26,1,2,3,4,5]), import.meta.url),
	"../appliances/models/refrigerator.ts": () => __vitePreload(() => import("./refrigerator-B-xhOxfl.js").then((n) => n.n), __vite__mapDeps([27,1,2,3,4,5]), import.meta.url),
	"../appliances/models/riceCooker.ts": () => __vitePreload(() => import("./riceCooker-CgcMjeIo.js").then((n) => n.n), __vite__mapDeps([28,1,2,3,4,5,22]), import.meta.url),
	"../appliances/models/robotVacuum.ts": () => __vitePreload(() => import("./robotVacuum-DnqYpj6X.js").then((n) => n.n), __vite__mapDeps([29,1,2,3,4,5]), import.meta.url),
	"../appliances/models/smartBin.ts": () => __vitePreload(() => import("./smartBin-B-UlZqBe.js").then((n) => n.n), __vite__mapDeps([30,1,2,3,4,5]), import.meta.url),
	"../appliances/models/standMixer.ts": () => __vitePreload(() => import("./standMixer-Ml3tfuLd.js").then((n) => n.n), __vite__mapDeps([31,1,2,3,4,5]), import.meta.url),
	"../appliances/models/television.ts": () => __vitePreload(() => import("./television-DN_8Dz3m.js").then((n) => n.n), __vite__mapDeps([32,1,2,3,4,5]), import.meta.url),
	"../appliances/models/toaster.ts": () => __vitePreload(() => import("./toaster-CkQRGCbY.js").then((n) => n.n), __vite__mapDeps([33,1,2,3,4,5]), import.meta.url),
	"../appliances/models/washer.ts": () => __vitePreload(() => import("./washer-BQrlLbRy.js").then((n) => n.n), __vite__mapDeps([34,1,2,3,4,5]), import.meta.url)
});
