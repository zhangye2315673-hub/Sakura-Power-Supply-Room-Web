...
| 6 | 吹风机 / `hair-dryer-branch` 解冻或热风改色 | 有冰冻时优先清除；否则随机将一根非当前路由色线改成有效橙红路由。 | `hair-dryer-heat-ribbon` 瞬时热风；改色时线缆重建。无全屏。 | 无持久图标。 | cue 文案根据分支相同；目标高亮。 | 两个分支需要不同标题/颜色，避免玩家不知道本次是解冻还是改色。 |
