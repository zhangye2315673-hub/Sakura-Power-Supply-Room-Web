...
const V2_REFERENCE_PATH = 'references/intake-v2/washer/views/front.png';
...
function applyWasherOutlineHierarchy(root: THREE.Object3D): void {
...
export function createWasherModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const accentLight = shiftColor(options.accent, 0.12, -0.06);
  ...
  const cabinet = kit.mesh(
    ...
    facetedPanelGeometry(2.7, 2.9, 0.22, 0.12),
    shellMaterial,
  );
  ...
  const topCap = kit.mesh(
    'washer-top-cap',
    facetedPanelGeometry(2.66, 1.98, 0.18, 0.12),
    accentLightMaterial,
  );
  ...
  controlBand.position.set(0, 2.645, 1.12);
  ...
  const dialBezel = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.24, 0.24, 0.085, 12),
    accentMaterial,
    dialPivot,
  );
  ...
  const dial = kit.mesh(
    'washer-program-dial',
    new THREE.CylinderGeometry(0.17, 0.185, 0.12, 12),
    shellLightMaterial,
    dialPivot,
  );
  ...
  const drumWall = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.73, 0.73, 0.98, 16, 1, true),
    drumMaterial,
    drumRotor,
    false,
  );
  ...
  const drumBack = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.705, 0.705, 0.055, 16),
    drumMaterial,
    drumRotor,
    false,
  );
  ...
  kit.mesh(
    ...
    new THREE.TorusGeometry(0.73, 0.05, 6, 16),
    metalMaterial,
    drumRotor,
    false,
  ).position.z = 0.01;
  ...
  const fixedGasket = kit.mesh(
    ...
    new THREE.TorusGeometry(0.82, 0.105, 8, 16),
    rubberMaterial,
    kit.root,
  );
  ...
  const gasketThroat = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.76, 0.7, 0.32, 16, 1, true),
    rubberMaterial,
    kit.root,
    false,
  );
  ...
  kit.mesh(
    ...
    new THREE.TorusGeometry(0.93, 0.14, 6, 12),
    accentLightMaterial,
    doorAssembly,
  );
  const innerDoorRing = kit.mesh(
    'washer-door-inner-ring',
    new THREE.TorusGeometry(0.73, 0.07, 6, 12),
    rubberMaterial,
    doorAssembly,
  );
  ...
  const glass = kit.mesh(
    'washer-door-glass',
    new THREE.CylinderGeometry(0.69, 0.73, 0.12, 16),
    glassMaterial,
    doorAssembly,
    false,
  );
  ...
  build.root.userData.sculptRuntime.colliders = [
    { id: 'washer-cabinet', type: 'box', node: 'root' },
    { id: 'washer-door', type: 'cylinder', node: 'washer-door-assembly' },
    { id: 'washer-drum-trigger', type: 'cylinder', node: 'washer-drum-rotor', trigger: true },
  ];
  build.root.userData.sculptRuntime.destructionGroups = [
    { id: 'washer-cabinet-system', nodes: ['washer-cabinet-back-core', 'washer-cabinet-left-side-shell', 'washer-cabinet-right-side-shell', 'washer-top-cap'] },
    { id: 'washer-control-system', nodes: ['washer-detergent-drawer-pivot', 'washer-program-dial-pivot', 'washer-display'] },
    { id: 'washer-door-system', nodes: ['washer-door-hinge', 'washer-door-assembly', 'washer-door-handle-pivot'] },
    { id: 'washer-drum-system', nodes: ['washer-drum-rotor', 'washer-tub-suds-rig', 'washer-glass-droplet-rig'] },
    { id: 'washer-rear-service', nodes: ['washer-rear-service-assembly', 'washer-drain-hose-socket', 'washer-power-cord-socket'] },
  ];
