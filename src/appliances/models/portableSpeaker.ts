...
function applyPortableSpeakerOutlineHierarchy(root: THREE.Object3D): void {
...
function carryHandleGeometry(): THREE.ExtrudeGeometry {
  ...
  const outer: Array<[number, number]> = [
    [-1.7, 0], [-1.7, 0.92], [-1.58, 1.37], [-1.31, 1.76], [-0.88, 2.05],
    [-0.36, 2.22], [0.36, 2.22], [0.88, 2.05], [1.31, 1.76], [1.58, 1.37],
    [1.7, 0.92], [1.7, 0],
  ];
  ...
  const inner: Array<[number, number]> = [
    [-1.36, 0], [-1.36, 0.88], [-1.25, 1.25], [-1.02, 1.55], [-0.65, 1.76],
    [-0.25, 1.87], [0.25, 1.87], [0.65, 1.76], [1.02, 1.55], [1.25, 1.25],
    [1.36, 0.88], [1.36, 0],
  ];
...
export function createPortableSpeakerModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const cabinet = kit.mesh(
    ...
    facetedPanelGeometry(3.2, 3.55, 1.45, 0.24),
    shellMaterial,
    cabinetPivot,
  );
  ...
  const crownHighlight = kit.mesh(
    ...
    facetedPanelGeometry(2.72, 0.16, 1.17, 0.055),
    shellHighlightMaterial,
    cabinetPivot,
    false,
  );
  crownHighlight.position.set(0, 3.48, -0.02);
  tag(crownHighlight, 'cabinet-shell', true);

  const frontSeam = kit.mesh(
    'portable-speaker-front-fascia-seam',
    facetedPanelGeometry(2.9, 3.09, 0.08, 0.22),
    shellSeamMaterial,
    cabinetPivot,
    false,
  );
  ...
  const fascia = kit.mesh(
    ...
    facetedPanelGeometry(2.78, 2.97, 0.13, 0.2),
    creamMaterial,
    fasciaPivot,
  );
  ...
  const fasciaInset = kit.mesh(
    ...
    facetedPanelGeometry(2.56, 2.76, 0.07, 0.16),
  ...
  const grilleRecess = kit.mesh(
    'portable-speaker-grille-recess-plane',
    facetedPanelGeometry(2.39, 2.58, 0.035, 0.13),
    creamMaterial,
    fasciaPivot,
    false,
  );
  grilleRecess.position.set(0, 1.95, 0.916);
  ...
  const handleHighlight = kit.mesh(
    ...
    facetedPanelGeometry(1.62, 0.055, 0.35, 0.018),
    shellHighlightMaterial,
    handlePivot,
    false,
  );
  ...
  [-1, 1].forEach((side, index) => {
    ...
    const hingeOuter = kit.mesh(
      ...
      new THREE.CylinderGeometry(0.29, 0.29, 0.16, 12),
      shellSeamMaterial,
      hingePivot,
    );
    ...
    const hingeCream = kit.mesh(
      ...
      new THREE.CylinderGeometry(0.235, 0.235, 0.19, 12),
      creamMaterial,
      hingePivot,
      false,
    );
    ...
    const hingeInset = kit.mesh(
      ...
      new THREE.CylinderGeometry(0.17, 0.17, 0.205, 10),
      creamHighlightMaterial,
      hingePivot,
      false,
    );
    ...
    const mintInsert = kit.mesh(
      ...
      facetedPanelGeometry(0.045, 1.24, 0.35, 0.015),
      mintMaterial,
      handlePivot,
      false,
    );
  ...
  const rearPanel = kit.mesh(
    ...
    facetedPanelGeometry(1.46, 0.68, 0.1, 0.09),
    creamMaterial,
    rearPivot,
  );
  ...
  const rearSlotRim = kit.mesh(
    ...
    facetedPanelGeometry(0.48, 0.1, 0.035, 0.028),
    shellSeamMaterial,
    rearPivot,
    false,
  );
  ...
  const rearSlot = kit.mesh(
    ...
    facetedPanelGeometry(0.39, 0.055, 0.04, 0.018),
    cavityMaterial,
    rearPivot,
    false,
  );
  ...
  const sharedFootGeometry = facetedPanelGeometry(0.46, 0.13, 0.58, 0.045);
  ...
  kit.socket('portable-speaker-left-connection-socket', kit.root, [-1.8325, 2.49000708, 1.21299384]);
  kit.socket('portable-speaker-right-connection-socket', kit.root, [1.8325, 2.49000708, 1.21299384]);
  kit.socket('portable-speaker-top-connection-socket', kit.root, [0, 5.04001415, 1.21299384]);
  kit.socket('portable-speaker-bottom-connection-socket', kit.root, [0, -0.06, 1.21299384]);
