...
const V2_REFERENCE_PATH = 'references/intake-v2/bubble-machine/views/front.png';
...
function applyBubbleMachineOutlineHierarchy(root: THREE.Object3D): void {
...
export function createBubbleMachineModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const shellMaterial = kit.material(0xf6eddf, { tint: 0x74677f });
  const shellHighlightMaterial = kit.material(0xfff7e8, { tint: 0x81738b });
  ...
  const mintMaterial = kit.material(mint, { tint: 0x667985 });
  const cavityMaterial = kit.material(0x403646, { tint: 0x302a3a });
  const hardwareMaterial = kit.material(0x77717e, { tint: 0x4b4658 });
  ...
  const shoulderFacetGeometry = new THREE.BoxGeometry(0.2, 0.34, 1.38);
  const leftShoulderFacet = kit.mesh(
    'bubble-machine-upper-shoulder-facet-left',
    shoulderFacetGeometry,
    shellHighlightMaterial,
    housingPivot,
    false,
  );
  leftShoulderFacet.position.set(-0.86, 0.72, 0);
  leftShoulderFacet.rotation.z = -0.12;
  leftShoulderFacet.userData.explodeWithParent = true;
  const rightShoulderFacet = kit.mesh(
    'bubble-machine-upper-shoulder-facet-right',
    shoulderFacetGeometry,
    shellHighlightMaterial,
    housingPivot,
    false,
  );
  rightShoulderFacet.position.set(0.86, 0.72, 0);
  rightShoulderFacet.rotation.z = 0.12;
  ...
  const cavityDisc = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.8, 0.8, 0.07, 16),
    cavityMaterial,
    frontAssembly,
    false,
  );
  ...
  const ringGeometry = new THREE.TorusGeometry(0.13, 0.032, 5, 12);
  const ringInnerGeometry = new THREE.TorusGeometry(0.102, 0.012, 4, 12);
  ...
  const wheelHub = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.17, 0.19, 0.12, 12),
    accentMaterial,
    wheelPivot,
  );
  ...
  const hubCap = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.045, 0.045, 0.018, 10),
    mintMaterial,
    wheelPivot,
    false,
  );
  ...
  const transparentWindow = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.82, 0.82, 0.026, 16),
    windowMaterial,
    frontAssembly,
    false,
  );
  ...
  const outerRim = kit.mesh(
    ...
    new THREE.TorusGeometry(0.86, 0.075, 6, 20),
    accentMaterial,
    frontAssembly,
  );
  ...
  const innerRim = kit.mesh(
    ...
    new THREE.TorusGeometry(0.78, 0.026, 5, 20),
    mintMaterial,
    frontAssembly,
    false,
  );
  ...
  const reservoirCap = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.16, 0.18, 0.12, 12),
    accentMaterial,
    reservoirPivot,
  );
  ...
  const rearCavity = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.59, 0.59, 0.055, 16),
    cavityMaterial,
    rearAssembly,
    false,
  );
  ...
  [0.25, 0.37, 0.49, 0.59].forEach((radius, index) => {
    const ring = kit.mesh(
      ...
      new THREE.TorusGeometry(radius, index === 3 ? 0.035 : 0.022, 5, 20),
      accentMaterial,
      grillePivot,
      false,
    );
  ...
  const rearGrilleCap = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.21, 0.21, 0.075, 12),
    accentMaterial,
    grillePivot,
  );
  ...
  build.root.userData.sculptRuntime.destructionGroups = [
    ...
    { id: 'floor-supports', nodes: ['bubble-machine-foot-pivot-1', 'bubble-machine-foot-pivot-2', 'bubble-machine-foot-pivot-3', 'bubble-machine-foot-pivot-4'] },
    { id: 'controls-and-tray', nodes: ['bubble-machine-control-knob-pivot', 'bubble-machine-drip-tray-pivot'] },
  ];
