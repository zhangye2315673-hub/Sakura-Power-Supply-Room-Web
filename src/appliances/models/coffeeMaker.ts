...
const V2_REFERENCE_PATH = 'references/intake-v2/coffee-maker/views/front.png';
...
function applyCoffeeMakerOutlineHierarchy(root: THREE.Object3D): void {
...
export function createCoffeeMakerModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const upperShell = kit.mesh(
    ...
    new RoundedBoxGeometry(1.58, 0.72, 1.04, 1, 0.13),
    shell,
    upperAssembly,
  );
  ...
  const upperCap = kit.mesh(
    ...
    new RoundedBoxGeometry(1.42, 0.1, 0.9, 1, 0.045),
    shellLight,
    upperAssembly,
    false,
  );
  ...
  const hopperCollar = kit.mesh(
    ...
    new RoundedBoxGeometry(1.12, 0.1, 0.66, 1, 0.045),
    seam,
    hopperPivot,
  );
  ...
  const hopper = kit.mesh(
    ...
    new RoundedBoxGeometry(1.34, 0.55, 0.78, 1, 0.1),
    hopperGlass,
    hopperPivot,
    false,
  );
  ...
  const hopperLid = kit.mesh(
    ...
    new RoundedBoxGeometry(1.38, 0.075, 0.82, 1, 0.045),
    shellLight,
    hopperPivot,
  );
  ...
  const rearSpine = kit.mesh(
    ...
    new RoundedBoxGeometry(1.42, 1.26, 0.38, 1, 0.11),
    accent,
  );
  ...
  const cavityBack = kit.mesh(
    ...
    new RoundedBoxGeometry(1.12, 0.9, 0.045, 1, 0.07),
    accentDeep,
    kit.root,
    false,
  );
  ...
  for (const [side, x] of [['left', -0.61], ['right', 0.61]] as const) {
    const post = kit.mesh(
      `coffee-maker-cavity-frame-post-${side}`,
      new RoundedBoxGeometry(0.16, 0.98, 0.17, 1, 0.045),
      accent,
      kit.root,
    );
    post.position.set(x, 0.88, -0.03);
    post.userData.part = 'cavity-frame';
  }

  const base = kit.mesh(
    'coffee-maker-separated-base',
    new RoundedBoxGeometry(1.56, 0.25, 1.08, 1, 0.09),
    shell,
  );
  ...
  const baseAccent = kit.mesh(
    ...
    new RoundedBoxGeometry(1.48, 0.095, 1, 1, 0.04),
    accent,
  );
  ...
  const dialSeat = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.22, 0.22, 0.055, 12),
    accentDeep,
    dialPivot,
  );
  ...
  const dial = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.18, 0.19, 0.09, 12),
    accent,
    dialPivot,
  );
  ...
  const brewHead = kit.mesh(
    ...
    new RoundedBoxGeometry(0.54, 0.2, 0.45, 1, 0.065),
    seam,
    brewHeadPivot,
  );
  ...
  const showerPlate = kit.mesh(
    ...
    new THREE.CylinderGeometry(0.14, 0.16, 0.045, 12),
    metal,
    brewHeadPivot,
  );
  ...
  const tray = kit.mesh(
    ...
    new RoundedBoxGeometry(1.08, 0.085, 0.64, 1, 0.05),
    seam,
  );
  ...
  for (let index = 0; index < 7; index += 1) {
    const slot = kit.mesh(
      ...
      new RoundedBoxGeometry(0.052, 0.012, 0.42, 1, 0.009),
      metal,
      kit.root,
      false,
    );
  ...
  const tank = kit.mesh(
    ...
    new RoundedBoxGeometry(0.31, 1.28, 0.36, 1, 0.075),
    waterTank,
    tankPivot,
    false,
  );
  ...
  const tankCap = kit.mesh(
    ...
    new RoundedBoxGeometry(0.29, 0.12, 0.34, 1, 0.045),
    accentDeep,
    tankPivot,
  );
  ...
  build.root.userData.outlineContract = { main: 0.0048, structure: 0.0041, detail: 0.0033, variation: 0.18, stable: true };
  build.root.userData.sculptRuntime.colliders = [
    { id: 'coffee-maker-upper', type: 'box', node: 'coffee-maker-upper-assembly-pivot' },
    { id: 'coffee-maker-base', type: 'box', node: 'coffee-maker-separated-base' },
    { id: 'coffee-maker-cup-trigger', type: 'cylinder', node: 'coffee-maker-cup-pivot', trigger: true },
  ];
  build.root.userData.sculptRuntime.destructionGroups = [
    { id: 'coffee-maker-upper-system', nodes: ['coffee-maker-upper-assembly-pivot', 'coffee-maker-control-dial-pivot', 'coffee-maker-brew-head-pivot'] },
    { id: 'coffee-maker-hopper-system', nodes: ['coffee-maker-bean-hopper-pivot'] },
    { id: 'coffee-maker-frame-system', nodes: ['coffee-maker-rear-l-shaped-spine', 'coffee-maker-cavity-frame-post-left', 'coffee-maker-cavity-frame-post-right'] },
    { id: 'coffee-maker-cup-system', nodes: ['coffee-maker-cup-pivot', 'coffee-maker-steam-socket'] },
    { id: 'coffee-maker-water-system', nodes: ['coffee-maker-water-tank-pivot', 'coffee-maker-water-tank-service-socket'] },
    { id: 'coffee-maker-rear-service', nodes: ['coffee-maker-rear-service-panel', 'coffee-maker-power-socket'] },
  ];
