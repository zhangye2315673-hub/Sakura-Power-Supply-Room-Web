...
function applyRadioOutlineHierarchy(root: THREE.Object3D): void {
...
export function createRadioModel(options: ApplianceModelOptions): ApplianceModelBuild {
  ...
  const shell = kit.mesh(
    'radio-outer-shell',
    new RoundedBoxGeometry(2.8, 1.62, 0.8, 2, 0.16),
    shellMaterial,
  );
  ...
  const frontLip = kit.mesh(
    ...
    new RoundedBoxGeometry(2.53, 1.32, 0.075, 2, 0.11),
  ...
  const frontPanel = kit.mesh(
    'radio-front-panel',
    new RoundedBoxGeometry(2.42, 1.22, 0.065, 2, 0.095),
    accentMaterial,
  );
  ...
  const speakerFrame = kit.mesh(
    'radio-speaker-frame',
    new RoundedBoxGeometry(1.2, 0.98, 0.075, 2, 0.095),
    shellHighlightMaterial,
  );
  ...
  const speakerCavity = kit.mesh(
    ...
    new RoundedBoxGeometry(1.08, 0.86, 0.055, 2, 0.07),
    cavityMaterial,
  );
  ...
  const speakerDiaphragm = kit.mesh(
    ...
    new RoundedBoxGeometry(0.98, 0.76, 0.025, 1, 0.055),
    accentDarkMaterial,
    speakerPivot,
    false,
  );
  ...
  const displayFrame = kit.mesh(
    ...
    new RoundedBoxGeometry(0.86, 0.5, 0.085, 2, 0.08),
    shellHighlightMaterial,
  );
  ...
  const displayFace = kit.mesh(
    ...
    new RoundedBoxGeometry(0.73, 0.37, 0.045, 1, 0.05),
    screenMaterial,
  );
  ...
  const glass = kit.mesh(
    ...
    new RoundedBoxGeometry(0.74, 0.38, 0.02, 1, 0.045),
    glassMaterial,
    kit.root,
    false,
  );
  ...
  const rearPanel = kit.mesh(
    ...
    new RoundedBoxGeometry(2.18, 0.92, 0.04, 2, 0.075),
    shellHighlightMaterial,
  );
  ...
  for (const x of [-1.05, 1.05]) {
    for (const z of [-0.25, 0.25]) {
      const foot = kit.mesh(
        ...
        new RoundedBoxGeometry(0.25, 0.12, 0.28, 1, 0.035),
        rubberMaterial,
        kit.root,
        false,
      );
  ...
  const antennaBracket = kit.mesh(
    ...
    new RoundedBoxGeometry(0.18, 0.36, 0.095, 1, 0.045),
    darkMetalMaterial,
  );
  ...
  build.root.userData.radioV2 = {
    ...
    frozenRuntime: ['radio-antenna-hinge-pivot', 'radio-speaker-socket', 'radio-antenna-root-socket'],
